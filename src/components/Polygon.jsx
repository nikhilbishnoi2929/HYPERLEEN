  ...
  return (
    <div>
        <div className='container max-w-[1164px] px-3 mx-auto'>
            ...
            <img className='w-full pointer-events-none pt-16 max-sm:pt-8 max-lg:pt-14' src={polygonFirst} alt="polygonFirst" data-aos="fade-right"/>
            <img className='w-full pt-6 pointer-events-none' src={polygonSecond} alt="polygonSecond" data-aos="fade-left" />
        </div>
    </div>
  )
}
