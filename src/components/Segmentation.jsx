  ...
  return (
    <div className='common_padding'>
      <div className='container'>
        <h2 className="font-gilroy font-medium text-4xl sm:text-5xl md:leading-[57px] max-w-[506px] mx-auto text-center">
          Image<span className="font-gilroy text-blue">Segmentation and</span>  Verification
        </h2>
        ...
        <div className="row lg:mt-10 items-center mx-auto max-sm:gap-5 max-lg:gap-12 max-lg:flex-col-reverse">
          <div className="w-full lg:w-1/2 lg:pr-3">
            <h2 className='font-gilroy font-medium sm:font-semibold text-11xl leading-[43px] w-full max-lg:text-center'>Image Segmentation</h2>
            ...
            <div className='w-full flex justify-center lg:justify-end overflow-hidden'>
              <div className='relative'>
                ...
                <div className='absolute top-0 left-0 w-full bg-blue p-4 rounded-tl-2xl rounded-tr-2xl'>
                  ...
                  <div className='font-gilroy font-semibold leading-10 text-11xl text-white pt-2'>Car</div>
                </div>
              </div>
            </div>
          </div>
