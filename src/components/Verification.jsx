                ...
                <div className='row items-center justify-between max-lg:max-w-[600px] max-lg:justify-center max-lg:flex-col max-lg:mx-auto'>
                    <div className='lg:w-1/2 px-3 relative'>
                        <div className='absolute top-0 w-full max-w-[502px]'>
                            <h3 className='sm:py-8 px-7 py-5 text-white font-semibold  md:text-11xl sm:text-3xl xsm:text-2xl text-xl font_gilroy_semibold sm:leading-[43px]'>Is Previous Selected Object is Correct?</h3>
                        </div>
                        <div className='max-w-[502px]' data-aos="fade-right">
                            <img src={verificationImg} alt="verifiction can or burger img" width={502} height={483} />
                        </div>
                        <div className='absolute bg-white rounded-2xl sm:p-4 p-2 shadow-whiteBox max-w-[332px] -bottom-10 left-0 xl:-translate-x-7 md:translate-x-2 -translate-x-3 translate-y-20'  data-aos="fade-right">
                    ...
                    <div className='lg:w-1/2 px-3 max-lg:mt-36'  data-aos="fade-left">
