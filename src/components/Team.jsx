...
const Team = () => {
  return (
    <div className='bg-ourTeam bg-no-repeat bg-center md:bg-full bg-cover py-[183px] relative'>
              ...
              <div className='bg-white pt-8 px-4 pb-4 rounded-br-2xl rounded-es-2xl'>
                <div className='flex items-center justify-between max-sm:flex-wrap'>
                  <div className='flex flex-col items-start'>
                    ...
                    <p className='font-poppins sm:pt-1 text-black text-lg'>Lead Data Annotator</p>
                  </div>
          ...
          <div className='lg:w-1/2 px-3 max-lg:mt-3'>
            <div className='max-w-[560px]  rounded-2xl relative'>
              ...
              <div className='bg-white pt-8 px-4 pb-4 rounded-br-2xl rounded-es-2xl'>
                ...
                <p className='font-poppins text-gray text-base pt-6'>Sarah Thompson brings over five years of experience in data labeling and annotation to our team. With a keen eye for detail and a passion for precision, Sarah leads our team of annotators, ensuring every piece of data is meticulously labeled and verified.</p>
              </div>
            </div>
          </div>
        </div>
